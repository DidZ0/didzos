...
#include "/home/didzo/.cache/wal/colors-wal-dwm.h"
...
static const int barpadding					= 2;
static const char *fonts[]          		= { "Fira Code:size=14:style=bold" };
static const char dmenufont[]       		= "Fira Code:size=14:style=bold";
...
/* tagging */
static const char *tags[] 	 = { "", "爵", "", "ﱮ", "", "פֿ", "阮", "切", "漣" };
